        ...
        {sidebarOpen && (
          <>
            ...
            >
              ...
              <div className="p-4 border-t border-white/10">
                <Link href="/" onClick={() => setSidebarOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/60 hover:text-white hover:bg-white/10 transition-all">
          ...
          <div className="flex items-center justify-between px-4 md:px-6 h-16">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/"
                target="_blank"
                className="flex items-center gap-1.5 px-3 py-1.5 bg-accent/10 text-accent text-xs font-medium rounded-full hover:bg-accent/20 transition-colors"
              >
              ...
              <div className="flex items-center gap-3 pl-3 border-l border-border">
                ...
                <div className="hidden md:block">
                  <p className="text-sm font-medium text-text">{adminUser?.name || "Admin"}</p>
                  <p className="text-xs text-text-muted">{adminUser?.email || "admin@intactghana.com"}</p>
                </div>
              </div>
            </div>
          </div>
